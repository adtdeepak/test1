...
.controller('overviewController', function($scope, CustomService, chartsService, ChartOptionsService) {
        ...
        var chartOptions = ChartOptionsService.getRevenueSubsTrend();
   		chartOBJ = chartsService.stackedBar.call($('#revenueTrendChart'),chartOptions, $scope);    
})

.controller('profileController', function($scope, CustomService, chartsService, ChartOptionsService) {
